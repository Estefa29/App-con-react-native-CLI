...
function CreateApartament({navigation}) {
    ...
    const createApartament = async () => {
        ...
        try {
            const response = await fetch('https://apiapartamentos.herokuapp.com/apartamento/nuevo', {
                method: 'POST',
                headers: {
            ...
            Alert.alert("Apartamento creado correctamente");
    ...
    <View style={styles.container}>
            ...
            <TouchableOpacity onPress={createApartament}  >
